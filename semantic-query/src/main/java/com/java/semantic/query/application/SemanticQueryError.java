...
public record SemanticQueryError(String code, String message, boolean retryable,
                                 @JsonInclude(JsonInclude.Include.NON_ABSENT) Optional<String> currentRevision) {
