    ...
    void should_return_discriminated_type_members_with_complete_analysis_and_next_page_follow_ups()
        ...
        mockMvc.perform(typeMemberRequest("""
                ...
                .andExpect(jsonPath("$.members[0].availableFollowUps[3].operation")
                        .value("GET_TYPE_MEMBERS"))
                .andExpect(jsonPath("$.members[0].availableFollowUps[3].api.method").value("POST"))
                .andExpect(jsonPath("$.members[0].availableFollowUps[3].api.path")
                        .value("/v1/discovery/type-members"))
                .andExpect(jsonPath("$.members[0].availableFollowUps[3].api.operationId")
                        .value("discoverTypeMembers"))
                .andExpect(jsonPath("$.members[0].availableFollowUps[3].request.repoId").value("orders"))
                .andExpect(jsonPath("$.members[0].availableFollowUps[3].request.expectedRevision")
                        .value(ANALYZED_REVISION.value()))
                .andExpect(jsonPath("$.members[0].availableFollowUps[3].request.sourceType.sourceFile")
                        .value(SOURCE_FILE))
                .andExpect(jsonPath("$.members[0].availableFollowUps[3].request.memberKinds[0]")
                        .value("FIELD"))
                .andExpect(jsonPath("$.members[0].availableFollowUps[3].request.offset").value(0))
                .andExpect(jsonPath("$.members[0].availableFollowUps[3].request.limit").value(50))
